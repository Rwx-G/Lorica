...
use clap::Parser;
use lorica_core::listeners::Listeners;
use lorica_core::server::configuration::Opt;
use lorica_core::server::Server;
...
use lorica_core::apps::http_app::ServeHttp;
use lorica_core::protocols::http::ServerSession;
...
fn entry_point(opt: Option<Opt>) {
    ...
    let mut h2c_app = lorica_core::apps::http_app::HttpServer::new_app(EchoApp);
