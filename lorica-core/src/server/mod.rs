...
/// The server object
///
/// This object represents an entire lorica server process which may have multiple independent
...
// NOTE: we need to keep the runtime outside async since
    ...
    ///
    /// This method is intended for lorica frontends that are NOT using the built-in
