...
///
/// Lorica configuration files are by default YAML files, but any key value format can potentially
/// be used.
///
/// # Extension
...
impl Default for ServerConf {
    fn default() -> Self {
        ServerConf {
            ...
            pid_file: "/tmp/lorica.pid".to_string(),
            upgrade_sock: "/tmp/lorica_upgrade.sock".to_string(),
            user: None,
            group: None,
            threads: 1,
...
pub struct Opt {
    ...
    #[clap(
        short,
        long,
        help = "This is the base set of command line arguments for a lorica-based service",
        long_help = None
    )]
    pub upgrade: bool,
...
version: 1
        ...
        assert_eq!("/tmp/lorica.pid", conf.pid_file);
    }
