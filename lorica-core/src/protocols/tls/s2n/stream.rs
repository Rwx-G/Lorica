...
use log::debug;
use lorica_tls::hash_certificate;
use std::fmt::Debug;
...
///
/// The underlying transport stream implementation (lorica_core::protocols::l4::stream::Stream)
/// used by Lorica buffers writes to the TCP connection. During the handshake process
