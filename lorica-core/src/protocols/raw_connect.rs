...
mod test_sync {
    ...
    fn test_generate_connect_header() {
        ...
        let req = generate_connect_header("lorica.org", 123, headers.iter()).unwrap();

        assert_eq!(req.method, http::method::Method::CONNECT);
        assert_eq!(req.uri.authority().unwrap(), "lorica.org:123");
        assert_eq!(req.headers.get("Host").unwrap(), "lorica.org:123");
    ...
    fn test_request_to_wire_auth_form() {
        ...
        assert_eq!(
            &b"CONNECT lorica.org:123 HTTP/1.1\r\nfoo: Bar\r\n\r\n"[..],
            &wire
        );
    }
    ...
    fn test_validate_connect_response() {
        ...
        peer_with_data.options.proxy_digest_user_data_hook = Some(std::sync::Arc::new(
            |_req: &http::request::Parts, _resp: &lorica_http::ResponseHeader| {
    ...
    async fn test_connect_write_request() {
        ...
        let wire = b"CONNECT lorica.org:123 HTTP/1.1\r\nhost: lorica.org:123\r\n\r\n";
        ...
        let to_wire = b"CONNECT lorica.org:123 HTTP/1.1\r\nhost: lorica.org:123\r\n\r\n";
