...
use lorica_cache::CachePhase;
use lorica_core::protocols::http::custom::CUSTOM_MESSAGE_QUEUE_SIZE;
use lorica_core::protocols::http::v2::{client::Http2Session, write_body};
    ...
    C: custom::Connector,
{
        ...
        SV::CTX: Send + Sync,
    {
        ...
        if session.cache.enabled() {
            lorica_cache::filters::upstream::request_filter(
                &mut req,
