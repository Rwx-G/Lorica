...
|------|---------|-------------|--------|
| 2026-08-12 | 1.2 | Epic 8 lance-dev closure: BMad completion audit + remediation landed (7/7 AC, counter arity guard, BanRecord struct). No Critical/High open. Status -> Done. | Romain G. |
