...
|------|---------|-------------|--------|
| 2026-08-12 | 1.3 | Epic 8 lance-dev closure: BMad audit remediation ("fix all") landed and re-validated in Docker (hot-upgrade-smoke 29/29, zero-drop across the live multi-process swap). No Critical/High open. Status -> Done. | Romain G. |
