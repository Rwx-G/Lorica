...
use lorica_core::services::{background::BackgroundService, ServiceReadyNotifier};
    ...
    S::Iter: BackendIter,
{
    pub async fn run(
        &self,
        shutdown: lorica_core::server::ShutdownWatch,
    ...
    S::Iter: BackendIter,
{
    ...
    async fn start(&self, shutdown: lorica_core::server::ShutdownWatch) -> () {
