    ...
    pub fn default_crs() -> Self {
        let rules = vec![
            ...
            WafRule {
                ...
                pattern: Regex::new(r"(?i)\bunion\b[\s/\*]+\b(select|all)\b").expect("invalid WAF regex pattern"),
                severity: 5,
            },
            WafRule {
                id: 942110,
                ...
                category: RuleCategory::SqlInjection,
                pattern: Regex::new(r"(?i)('|%27)\s*(--|#|/\*)").expect("invalid WAF regex pattern"),
                severity: 4,
            },
            WafRule {
                id: 942120,
                ...
                category: RuleCategory::SqlInjection,
                pattern: Regex::new(r"(?i)\b(or|and)\b\s+\d+\s*=\s*\d+").expect("invalid WAF regex pattern"),
                severity: 5,
            },
            WafRule {
                id: 942130,
            ...
            WafRule {
                ...
                category: RuleCategory::SqlInjection,
                pattern: Regex::new(r"(?i);\s*\b(select|insert|update|delete|drop|alter)\b").expect("invalid WAF regex pattern"),
                severity: 4,
            },
            // --- XSS (CRS 941xxx) ---
            WafRule {
                ...
                pattern: Regex::new(r"(?i)<\s*script[\s>]").expect("invalid WAF regex pattern"),
                severity: 5,
            },
            WafRule {
                id: 941110,
            ...
            WafRule {
                ...
                category: RuleCategory::Xss,
                pattern: Regex::new(r"(?i)javascript\s*:").expect("invalid WAF regex pattern"),
                severity: 5,
            },
            WafRule {
                id: 941130,
                ...
                category: RuleCategory::Xss,
                pattern: Regex::new(r"(?i)data\s*:\s*text/html").expect("invalid WAF regex pattern"),
                severity: 4,
            },
            WafRule {
                id: 941140,
                ...
                category: RuleCategory::Xss,
                pattern: Regex::new(r"(?i)<\s*(iframe|object|embed|applet)[\s>]").expect("invalid WAF regex pattern"),
                severity: 4,
            },
            WafRule {
                id: 941150,
                ...
                category: RuleCategory::Xss,
                pattern: Regex::new(r"(?i)<\s*svg[^>]*\bonload\s*=").expect("invalid WAF regex pattern"),
                severity: 4,
            },
            ...
            WafRule {
                ...
                pattern: Regex::new(r"(\.\./|\.\.\\|%2e%2e[/\\%]|%252e%252e)").expect("invalid WAF regex pattern"),
                severity: 5,
            },
            WafRule {
                id: 930110,
            ...
            WafRule {
                ...
                category: RuleCategory::PathTraversal,
                pattern: Regex::new(r"(%00|\\x00|\x00)").expect("invalid WAF regex pattern"),
                severity: 5,
            },
            ...
            WafRule {
                ...
                pattern: Regex::new(r"[;&|`]\s*(cat|ls|id|whoami|wget|curl|nc|bash|sh|python|perl|ruby|php)\b").expect("invalid WAF regex pattern"),
                severity: 5,
            },
            WafRule {
                id: 932110,
                ...
                category: RuleCategory::CommandInjection,
                pattern: Regex::new(r"(`[^`]+`|\$\([^)]+\))").expect("invalid WAF regex pattern"),
                severity: 4,
            },
            ...
            WafRule {
                ...
                category: RuleCategory::ProtocolViolation,
                pattern: Regex::new(r"(%0d%0a|%0d|%0a|\r\n)").expect("invalid WAF regex pattern"),
                severity: 4,
            },
            // --- SSRF (CRS 934xxx) ---
            WafRule {
