...
//! `lorica-ketama/examples/health_aware_selector.rs`.
//!
//! For a carefully crafted real-world example, see the [`lorica-lb`](https://docs.rs/lorica-lb)
//! crate.
...
mod tests {
    ...
    fn matches_nginx_sample() {
        ...
        assert_eq!(
            c.node(b"/lorica/team/is/cool/and/this/is/a/long/uri"),
            Some(get_sockaddr("127.0.0.1:7778"))
        );
        assert_eq!(
