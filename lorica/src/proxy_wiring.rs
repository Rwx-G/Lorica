...
// Story 8.1 / E3 : RequestCtx struct moved to proxy_wiring/context.rs.
pub mod context;
pub(crate) use context::RequestCtx;

// Story 8.1 / E4 : routing surface (RouteEntry, MtlsEnforcer,
// ProxyConfig, ProxyConfigGlobals + impl) moved to proxy_wiring/routing.rs.
pub mod routing;
pub use routing::{MtlsEnforcer, ProxyConfig, ProxyConfigGlobals, RouteEntry};
...
#[cfg(test)]
pub(crate) use mirror_rewrite::{build_mirror_url, compile_rewrite_rule, CompiledRewriteRule};
pub(crate) use mirror_rewrite::{
    apply_response_rewrites, build_mirror_forward_headers, mirror_sample_hit,
    request_has_body, should_rewrite_response, spawn_mirrors, MirrorBodyState,
...
pub(crate) use helpers::{cache_vary_for_request, extract_host, sanitize_html};
#[cfg(test)]
pub(crate) use helpers::ip_matches;
...
// grouped by concern instead of inflating proxy_wiring.rs root.
pub mod filters;
